    ...
    <script>
        require([
            ...
            on(dom.byId("render1"),"click",function () {
                window.location.href = '/signalHeatMapF1';
            });
            on(dom.byId("render2"),"click",function () {
                window.location.href = '/signalHeatMapF2';
            });
            on(dom.byId("render3"),"click",function () {
                window.location.href = '/signalHeatMapF3';
            });
            ...
            try {
                ...
                var point = [
                    ...
                    [114.3489, 38.2477700, 300],
                    [114.3486, 38.2477700, 400],
                    [114.34855, 38.2477700, 500],
                    [114.348544, 38.2477700, 200],
                    [114.3489114, 38.2477700, 400]
                ];
                //热力图配置
                var option = {
                    title: {
